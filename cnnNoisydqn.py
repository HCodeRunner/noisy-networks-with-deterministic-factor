...
from base.noisynetws import compute_td_loss, CnnNoisyDQN
...
save_dir = "data/noisydqn_pong_five2.npz"
...
for i in range(arvg_num):
    ...
    for frame_idx in range(1, num_frames + 1):
        ...
        if len(replay_buffer) > replay_initial:
            loss = compute_td_loss(batch_size, replay_buffer, current_model, target_model, gamma, optimizer)
